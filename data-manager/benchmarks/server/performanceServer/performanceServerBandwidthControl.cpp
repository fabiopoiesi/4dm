...
// #define SENDING_LIMIT 2919912000
#define SENDING_LIMIT 15000000
#define AVERAGE_WRITE_TIME_IN_NS 7883
...
int sleepTimeInClock = 10; // length of time to sleep, in nanosecond
...
int main() {
	...
	// Calculate wait time
	uint64_t packetsXSecond = SENDING_LIMIT / PACKET_SIZE;
	std::cout << "packetsXSecond: " << packetsXSecond << std::endl;
	sleepTimeInClock = (1.0f / packetsXSecond) * CLOCKS_PER_SEC;
	std::cout << "sleepTime: " << sleepTimeInClock << std::endl;
